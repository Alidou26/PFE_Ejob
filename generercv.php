				...
				<div class="dashboard-nav">
					<div class="dashboard-nav-inner">
						...
						<ul data-submenu-title="Mon Profil">
                            ...
                            <li class="active"><a href="#"><i class="icon-material-outline-speaker-notes"></i>Générer CV</a></li>
			...
			<div class="row">
				...
				<div class="col-xl-12" >
					<div class="dashboard-box" >
						...
						<!-- Headline -->
						<div class="headline">
							<h3><i class="icon-feather-star"></i>Exemples</h3>
						</div>
                ...
                <div class="col-xl-5 col-md-6"> 
                 <a href="generer-cv/cv1/index.php" class="photo-box small" data-background-image="generer-cv/imgcv1.jpg">
				...
				<div class="col-xl-5 col-md-6"> 
                 <a href="generer-cv/cv2/index.php" class="photo-box small" data-background-image="generer-cv/imgcv2.jpg">
					<div class="photo-box-content">
						<h3></h3>
						<span>Télécharger</span>
					</div>
