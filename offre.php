	...
	<div class="dashboard-content-container" data-simplebar>
		<div class="dashboard-content-inner" >
			...
			<div class="dashboard-headline">
				...
				<span class="margin-top-7"><a href="#"><?=$annonce['titre'] ?></a></span>
			...
			<div class="row">
				...
				<div class="col-xl-12">
					<div class="dashboard-box margin-top-0">
						...
						<!-- Headline -->
						<div class="headline">
							<h3><i class="icon-material-outline-supervisor-account"></i> <?= nombreCandidature($annonce['id_annonce']) ?> Candidats</h3>
						</div>
