		...
		<div class="dashboard-content-inner" >
			...
			<div class="row">
							...
							<div class="row">
								...
								<div class="col-auto">
									<div class="avatar-wrapper" data-tippy-placement="bottom" title="Changer Photo de profil">
										<img class="profile-pic" src="<?php echo $_SESSION['photo']?>" alt="" />
									...
									<div class="row">
										...
										<div class="col-xl-6">
											<div class="submit-field">
												...
												<input type="text" name="nom" class="with-border" value="<?php echo $_SESSION['nom']?>">
											</div>
										</div>
                                        ...
                                        <div class="col-xl-6">
											<div class="submit-field">
												<h5>PRENOM</h5>
												<input type="text" name="prenom" class="with-border"  value="<?php echo $_SESSION['prenom']?>">
											</div>
										</div>
                ...
                <select data-size="7" data-live-search="true" name="pays">
                    ...
                    <option value="<?=$_SESSION['pays'] ?>" selected>Ancien Pays</option>
                    ...
                    <option value="zw">Zimbabwe</option>
                                        ...
                                        <div class="col-xl-6">
											<div class="submit-field">
												<h5>EMAIL</h5>
												<input type="text" name="email" class="with-border" value="<?php echo $_SESSION['email']?>">
											</div>
										</div>
                                        ...
                                        <div class="col-xl-6">
											<div class="submit-field">
												<h5>TELEPHONE</h5>
												<input type="text" name="telephone" class="with-border" value="<?php echo $_SESSION['telephone']?>">
											</div>
										</div>
										...
										<div class="col-xl-6">
											...
											<div class="submit-field">
												<div class="account-type">
													<div>
													<input type="radio" value="candidat" id="freelancer-radio" class="account-type-radio" checked/>
														<label for="freelancer-radio" class="ripple-effect-dark"><i class="icon-material-outline-account-circle" ></i>CANDIDAT</label>
													</div>
												</div>
											</div>
										</div>
				...
				<!-- Button -->
				<div class="col-xl-12">
				<button class="button ripple-effect big margin-top-10" type="submit" form="parametreUtilisateur">ENREGISTRER</button>	
				</div>
